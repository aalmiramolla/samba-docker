[![logo](https://raw.githubusercontent.com/aalmiramolla/samba/master/logo.jpg)](https://www.samba.org)
...
Fork from https://github.com/dperson/samba/ with the fixes of https://github.com/dperson/samba/issues/407 and removed other architectures.
...
## Hosting a Samba instance
    ...
    sudo docker run -it -p 139:139 -p 445:445 -d aalmiramolla/samba -p

OR set local storage:

    sudo docker run -it --name samba -p 139:139 -p 445:445 \
                -v /path/to/directory:/mount \
                -d aalmiramolla/samba -p

## Configuration

    sudo docker run -it --rm aalmiramolla/samba -h
...
### Setting the Timezone
    ...
    sudo docker run -it -e TZ=EST5EDT -p 139:139 -p 445:445 -d aalmiramolla/samba -p
...
through a [GitHub issue](https://github.com/aalmiramolla/samba/issues).
